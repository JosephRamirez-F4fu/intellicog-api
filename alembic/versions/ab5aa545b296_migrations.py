...
Revision ID: ab5aa545b296
Revises: 
Create Date: 2025-06-24 07:30:26.271758
...
def upgrade() -> None:
    ...
    sa.Column('speciality', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    ...
    op.create_index(op.f('ix_passwordresetcodes_code'), 'passwordresetcodes', ['code'], unique=False)
    ...
    sa.Column('manual_classification', sa.Enum('NORMAL', 'MCI', 'MILD_DEMENTIA', 'MODERATE_DEMENTIA', 'SEVERE_DEMENTIA', 'DEMENTIA', 'ALZHEIMERS', 'MCI_DEMENTIA', name='classification'), nullable=True),
    sa.Column('model_classification', sa.Enum('NORMAL', 'MCI', 'MILD_DEMENTIA', 'MODERATE_DEMENTIA', 'SEVERE_DEMENTIA', 'DEMENTIA', 'ALZHEIMERS', 'MCI_DEMENTIA', name='classification'), nullable=True),
    ...
    op.create_table('patientcomorbilites',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
